 ...
 * the {@link org.jdrupes.mdoclet.internal.tool tool}, and a series of
 * {@link org.jdrupes.mdoclet.internal.doclets doclets}.
 *
 ...
 *        <dd><p>
 *          The {@link org.jdrupes.mdoclet.internal.doclets.formats.html.HtmlDoclet} class
 *          and other classes in the
 *          {@link org.jdrupes.mdoclet.internal.doclets.formats.html formats.html} package
 ...
 *          {@link org.jdrupes.mdoclet.internal.doclets.formats.html.HtmlDocletWriter}.
 *
 *          <p>The {@link org.jdrupes.mdoclet.internal.doclets.formats.html.HtmlConfiguration} class
 *          provides configuration information that is relevant to all the generated pages.
 *          The class extends the {@link org.jdrupes.mdoclet.internal.doclets.toolkit.BaseConfiguration}
 *          class provided by the toolkit layer.
 *
 *          <p>The classes in the {@code formats.html} package use an internal
 *          library in the
 *          {@link org.jdrupes.mdoclet.internal.doclets.formats.html.markup formats.html.markup} package,
 *          to create trees (or acyclic graphs) of
 *          {@linkplain org.jdrupes.mdoclet.internal.doclets.formats.html.markup.HtmlTree HTML tree nodes}.
 *          Apart from using a common format-neutral supertype,
 *          {@link org.jdrupes.mdoclet.internal.doclets.toolkit.Content}, the {@code markup} library
 *          is mostly independent of the rest of the javadoc software stack.
 *
 *        <dt id="toolkit">Toolkit
 *        <dd><p>
 *          The {@link org.jdrupes.mdoclet.internal.doclets.toolkit toolkit} package provides
 *          support for a format-neutral
 *          {@linkplain org.jdrupes.mdoclet.internal.doclets.toolkit.AbstractDoclet abstract doclet},
 *          which uses
 *          {@linkplain org.jdrupes.mdoclet.internal.doclets.toolkit.builders.AbstractBuilder builders}
 *          to generate pages of abstract
 *          {@linkplain org.jdrupes.mdoclet.internal.doclets.toolkit.Content content}.
 *
 ...
 *          {@linkplain org.jdrupes.mdoclet.internal.doclets.toolkit.WriterFactory writer factory}.
 *
 *          <p>The {@link org.jdrupes.mdoclet.internal.doclets.toolkit.BaseConfiguration} provides
 ...
 *          {@linkplain org.jdrupes.mdoclet.internal.doclets.toolkit.util utility classes}
 ...
 *          {@link org.jdrupes.mdoclet.internal.doclets.toolkit.WorkArounds} class.
 *
 *        <dt>Other Doclets
 *        <dd><p>
 *          Doclets are obviously not required to use
 *          {@link org.jdrupes.mdoclet.internal.doclets.toolkit.AbstractDoclet} and other classes in
