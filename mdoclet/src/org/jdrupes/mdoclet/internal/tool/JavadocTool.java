...
public class JavadocTool extends com.sun.tools.javac.main.JavaCompiler {
    ...
    public DocletEnvironment getEnvironment(ToolOptions toolOptions,
        ...
        try {
            StandardJavaFileManager fm
                = toolEnv.fileManager instanceof StandardJavaFileManager sfm
                    ? sfm
                    : null;
            Set<String> packageNames = new LinkedHashSet<>();
            // Normally, the args should be a series of package names or file
            // names.
            ...
            for (String arg : javaNames) {
                if (fm != null && arg.endsWith(".java") && isRegularFile(arg)) {
                    ...
                    if (fm == null) {
                        String text
                            = log.getText("main.assertion.error", "fm == null");
            ...
            if (log.hasErrors()) {
                ...
                Throwable t
                    = abort.getCause() == null ? abort : abort.getCause();
    ...
    private void parse(Iterable<? extends JavaFileObject> files,
    ...
    public static boolean isValidClassName(String s) {
        ...
        if (surrogatesSupported) {
            ...
            if (!Character.isJavaIdentifierStart(cp))
                return false;
            for (int j = Character.charCount(cp); j < s.length();
