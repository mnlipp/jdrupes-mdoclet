...
public class SimpleTaglet extends BaseTaglet implements InheritableTaglet {
     ...
     * @param locations the possible locations that this tag can appear in
     */
    public SimpleTaglet(DocTree.Kind tagKind, String header,
     ...
     * @param locations the possible locations that this tag can appear in
     */
    public SimpleTaglet(String tagName, String header,
            Set<Location> locations) {
     ...
     */
    public SimpleTaglet(DocTree.Kind tagKind, String header,
            Set<Location> locations, boolean enabled) {
    ...
    public Output inherit(Element owner, DocTree tag, boolean isFirstSentence,
        ...
        try {
            ...
            var r = docFinder.trySearch((ExecutableElement) owner,
                m -> Result.fromOptional(extractFirst(m, configuration.utils)))
                .toOptional();
            return r
                .map(result -> new Output(result.tag, result.method,
    ...
    record Documentation(DocTree tag, List<? extends DocTree> description,
    ...
    private Optional<Documentation> extractFirst(ExecutableElement m,
        ...
        return Optional.of(new Documentation(t,
            utils.getCommentHelper(m).getDescription(t), m));
    }
