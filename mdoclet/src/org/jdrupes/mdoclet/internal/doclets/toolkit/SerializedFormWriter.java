...
public interface SerializedFormWriter {
    ...
    interface SerialFieldWriter {
         ...
         * @param content the content to which the member description will be added
         */
        void addMemberDescription(VariableElement field,
         ...
         */
        void addMemberHeader(TypeMirror fieldType, String fieldName,
                Content content);
    ...
    interface SerialMethodWriter {
         ...
         */
        void addDeprecatedMemberInfo(ExecutableElement member,
         ...
         * information will be added
         */
        void addMemberDescription(ExecutableElement member,
                Content methodsContent);
