...
public class MethodBuilder extends AbstractMemberBuilder {
    ...
    protected void buildMethodDoc(Content detailsList) throws DocletException {
        if (hasMembersToDocument()) {
            Content methodDetailsHeader
                = writer.getMethodDetailsHeader(detailsList);
            ...
            Content methodDetails
                = writer.getMethodDetails(methodDetailsHeader, memberList);
    ...
    protected void buildMethodComments(Content methodContent) {
        if (!options.noComment()) {
            assert utils.isMethod(currentMethod); // not all executables are
                                                  // methods
