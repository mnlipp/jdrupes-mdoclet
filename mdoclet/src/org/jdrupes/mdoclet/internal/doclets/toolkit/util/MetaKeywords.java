...
public class MetaKeywords {
    ...
    protected List<String> getClassKeyword(TypeElement typeElement) {
        String cltypelower
            = utils.isPlainInterface(typeElement) ? "interface" : "class";
        return List
            .of(utils.getFullyQualifiedName(typeElement) + " " + cltypelower);
    }
    ...
    public List<String> getMetaKeywords(PackageElement packageElement) {
        if (options.keywords()) {
            return List
                .of(utils.getPackageName(packageElement) + " " + "package");
        } else {
            return List.of();
        }
    }
