...
public class TypeElementCatalog {
     ...
     */
    public TypeElementCatalog(Iterable<TypeElement> typeElements,
    ...
    private void addTypeElement(TypeElement typeElement,
            Map<PackageElement, SortedSet<TypeElement>> map) {

        PackageElement pkg = utils.containingPackage(typeElement);
        if (utils.isSpecified(pkg) || configuration.getOptions().noDeprecated()
            && utils.isDeprecated(pkg)) {
    ...
    public SortedSet<TypeElement> allClasses(PackageElement packageElement) {
        return utils.isSpecified(packageElement)
            ? utils.getTypeElementsAsSortedSet(
                utils.getEnclosedTypeElements(packageElement))
            : allClasses.getOrDefault(packageElement,
