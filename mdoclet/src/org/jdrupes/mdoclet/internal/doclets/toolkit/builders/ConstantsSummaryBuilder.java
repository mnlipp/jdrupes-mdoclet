...
public class ConstantsSummaryBuilder extends AbstractBuilder {
    ...
    public void build() throws DocletException {
        boolean anyConstants
            = configuration.packages.stream().anyMatch(this::hasConstantField);
        if (!anyConstants) {
            return;
        }
    ...
    protected void buildContents() {
        ...
        for (PackageElement pkg : configuration.packages) {
            ...
            if (hasConstantField(pkg)
                && !packageGroupHeadings.contains(abbrevPackageName)) {
    ...
    private class ConstantFieldBuilder {
        ...
        protected SortedSet<VariableElement> members() {
            ...
            SortedSet<VariableElement> includes = new TreeSet<>(
