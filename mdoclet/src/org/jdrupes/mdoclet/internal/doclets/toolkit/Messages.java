...
public class Messages {
     ...
     * @param args  optional arguments to be replaced in the message
     */
    public void error(DocTreePath path, int start, int pos, int end, String key,
            Object... args) {
     ...
     * @param args  optional arguments to be replaced in the message
     */
    public void error(FileObject fo, int start, int pos, int end, String key,
            Object... args) {
     ...
     * @param args  optional arguments to be replaced in the message
     */
    public void warning(DocTreePath path, int start, int pos, int end,
     ...
     * @param args  optional arguments to be replaced in the message
     */
    public void warning(FileObject fo, int start, int pos, int end, String key,
            Object... args) {
    ...
    public void notice(String key, Object... args) {
        if (!configuration.getOptions().quiet()) {
            // Note: we do not use report(NOTE, ...) which would prefix the
            // output with "Note:"
            reporter.getDiagnosticWriter()
                .println(resources.getText(key, args));
        }
    }
    ...
    private void report(Diagnostic.Kind k, FileObject fo, int start, int pos,
            int end, String msg) {
        reporter.print(k, fo, start, pos, end, msg);
    }

    private void report(Diagnostic.Kind k, DocTreePath path, int start, int pos,
            int end, String msg) {
