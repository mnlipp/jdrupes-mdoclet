...
public class IndexItem {
    ...
    public static IndexItem of(ModuleElement moduleElement, Utils utils) {
        return new IndexItem(moduleElement,
            utils.getFullyQualifiedName(moduleElement));
    }
    ...
    public static IndexItem of(PackageElement packageElement, Utils utils) {
        return new IndexItem(packageElement,
     ...
     */
    public static IndexItem of(TypeElement typeElement, Element member,
            Utils utils) {
    ...
    public String toJSON() {
        ...
        case TAGS:
            ...
            if (!description.isEmpty()) {
                item.append("\"d\":\"").append(escapeQuotes(description))
                    .append("\",");
            }
