...
public class ConstructorBuilder extends AbstractMemberBuilder {
    ...
    protected void buildConstructorDoc(Content target) throws DocletException {
        if (hasMembersToDocument()) {
            Content constructorDetailsHeader
                = writer.getConstructorDetailsHeader(target);
            Content memberList = writer.getMemberList();

            for (Element constructor : constructors) {
                currentConstructor = (ExecutableElement) constructor;
                Content constructorContent
                    = writer.getConstructorHeaderContent(currentConstructor);
            ...
            Content constructorDetails = writer
                .getConstructorDetails(constructorDetailsHeader, memberList);
