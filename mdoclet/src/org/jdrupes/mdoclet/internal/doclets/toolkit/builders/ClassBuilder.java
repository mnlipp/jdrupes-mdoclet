...
public class ClassBuilder extends AbstractBuilder {
     ...
     */
    private ClassBuilder(Context context, TypeElement typeElement,
            ClassWriter writer) {
        super(context);
    ...
    protected void buildClassDoc() throws DocletException {
        ...
        default -> throw new IllegalStateException(
            typeElement.getKind() + " " + typeElement);
        };
     ...
     * @throws DocletException if there is a problem while building the documentation
     */
    protected void buildFieldDetails(Content detailsList)
            throws DocletException {
     ...
     * @throws DocletException if there is a problem while building the documentation
     */
    protected void buildConstructorDetails(Content detailsList)
            throws DocletException {
     ...
     * @throws DocletException if there is a problem while building the documentation
     */
    protected void buildMethodDetails(Content detailsList)
            throws DocletException {
    ...
    private void setEnumDocumentation(TypeElement elem) {
        ...
        for (ExecutableElement ee : utils.getMethods(elem)) {
            ...
            } else if (name.contentEquals("valueOf")
    ...
    private void setRecordDocumentation(TypeElement elem) {
        ...
        for (ExecutableElement ee : utils.getMethods(elem)) {
            ...
            if (name.contentEquals("equals")) {
                if (params.size() == 1 && utils.typeUtils
                    .isSameType(params.get(0).asType(), objectType)) {
                    utils.removeCommentHelper(ee); // purge previous entry
