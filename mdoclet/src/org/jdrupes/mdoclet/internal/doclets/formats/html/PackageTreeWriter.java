...
public class PackageTreeWriter extends AbstractTreeWriter {
     ...
     */
    public PackageTreeWriter(HtmlConfiguration configuration, DocPath path,
    ...
    public static void generate(HtmlConfiguration configuration,
        ...
        DocPath path = configuration.docPaths.forPackage(pkg)
            .resolve(DocPaths.PACKAGE_TREE);
        PackageTreeWriter packgen
            = new PackageTreeWriter(configuration, path, pkg);
    ...
    protected void addLinkToAllPackages(Content target) {
        ...
        ul.add(
            getNavLinkToOverviewTree(resources.getText("doclet.All_Packages")));
        target.add(ul);
    }
}
