...
import org.jdrupes.mdoclet.internal.doclets.toolkit.EnumConstantWriter;
...
public class EnumConstantWriterImpl extends AbstractMemberWriter
    ...
    @Override
    public void addComments(VariableElement enumConstant,
            Content enumConstants) {
    ...
    public TableHeader getSummaryTableHeader(Element member) {
        return new TableHeader(contents.enumConstantLabel,
