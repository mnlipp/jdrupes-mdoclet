...
import org.jdrupes.mdoclet.internal.doclets.toolkit.util.SummaryAPIListBuilder;
...
public class HtmlIds {
    ...
    static final HtmlId ANNOTATION_TYPE_ELEMENT_DETAIL
        = HtmlId.of("annotation-interface-element-detail");
    static final HtmlId ANNOTATION_TYPE_OPTIONAL_ELEMENT_SUMMARY
        = HtmlId.of("annotation-interface-optional-element-summary");
    static final HtmlId ANNOTATION_TYPE_REQUIRED_ELEMENT_SUMMARY
    ...
    static final HtmlId ENUM_CONSTANT_DETAIL
        = HtmlId.of("enum-constant-detail");
    static final HtmlId ENUM_CONSTANT_SUMMARY
        = HtmlId.of("enum-constant-summary");
    ...
    static final HtmlId METHOD_SUMMARY_TABLE
        = HtmlId.of("method-summary-table");
    ...
    static final HtmlId NAVBAR_TOGGLE_BUTTON
        = HtmlId.of("navbar-toggle-button");
    static final HtmlId NAVBAR_TOP = HtmlId.of("navbar-top");
    static final HtmlId NAVBAR_TOP_FIRSTROW = HtmlId.of("navbar-top-firstrow");
    static final HtmlId NESTED_CLASS_SUMMARY
        = HtmlId.of("nested-class-summary");
    ...
    static final HtmlId PACKAGE_SUMMARY_TABLE
        = HtmlId.of("package-summary-table");
    ...
    static final HtmlId RELATED_PACKAGE_SUMMARY
        = HtmlId.of("related-package-summary");
    ...
    private static final String ENUM_CONSTANTS_INHERITANCE
        = "enum-constants-inherited-from-class-";
    private static final String FIELDS_INHERITANCE
        = "fields-inherited-from-class-";
    private static final String METHODS_INHERITANCE
        = "methods-inherited-from-class-";
    private static final String NESTED_CLASSES_INHERITANCE
        = "nested-classes-inherited-from-class-";
    private static final String PROPERTIES_INHERITANCE
    ...
    HtmlId forMember(TypeElement typeElement, VariableElement member) {
        return HtmlId
            .of(typeElement.getQualifiedName() + "." + member.getSimpleName());
    }
    ...
    protected HtmlId forErasure(ExecutableElement executableElement) {
        final StringBuilder buf
            = new StringBuilder(executableElement.getSimpleName().toString());
        buf.append("(");
        ...
        for (int i = 0; i < parameters.size(); i++) {
            ...
            SimpleTypeVisitor9<Boolean, Void> stv = new SimpleTypeVisitor9<>() {
                ...
                public Boolean visitTypeVariable(TypeVariable t, Void p) {
                    buf.append(
                        utils.asTypeElement(t).getQualifiedName().toString());
    ...
    HtmlId forInheritedClasses(TypeElement element) {
        return HtmlId.of(
            NESTED_CLASSES_INHERITANCE + utils.getFullyQualifiedName(element));
    }
    ...
    // compared to just using the fully qualified name, but would be a change in
    // the value.
     ...
     */
    static HtmlId
            forSummaryKind(SummaryAPIListBuilder.SummaryElementKind kind) {
    ...
    static HtmlId forMemberSummary(VisibleMemberTable.Kind kind) {
        ...
        // We generate separate summaries for optional and required annotation
        // members
        case ANNOTATION_TYPE_MEMBER -> throw new IllegalArgumentException(
    ...
    public HtmlId forPage(Navigation.PageMode page) {
        return HtmlId
            .of(page.name().toLowerCase(Locale.ROOT).replace("_", "-"));
    }
