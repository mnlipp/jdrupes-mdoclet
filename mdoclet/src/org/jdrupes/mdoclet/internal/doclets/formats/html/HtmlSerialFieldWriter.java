...
public class HtmlSerialFieldWriter extends FieldWriterImpl
    ...
    public Content getSerializableFields(String heading, Content source) {
        ...
        if (!source.isEmpty()) {
            ...
            var serialHeading = HtmlTree.HEADING(
                Headings.SerializedForm.CLASS_SUBHEADING, headingContent);
    ...
    @Override
    public void addMemberHeader(TypeMirror fieldType, String fieldName,
            Content content) {
        ...
        Content fieldContent = writer.getLink(new HtmlLinkInfo(
            configuration, HtmlLinkInfo.Kind.LINK_TYPE_PARAMS_AND_BOUNDS,
            fieldType));
     ...
     */
    @Override
    public void addMemberDeprecatedInfo(VariableElement field,
            Content content) {
     ...
     */
    @Override
    public void addMemberDescription(VariableElement field,
            SerialFieldTree serialFieldTag, Content content) {
