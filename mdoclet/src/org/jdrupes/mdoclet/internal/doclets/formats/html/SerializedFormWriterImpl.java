...
public class SerializedFormWriterImpl extends SubWriterHolderWriter
    ...
    public SerializedFormWriterImpl(HtmlConfiguration configuration) {
        ...
        configuration.conditionalPages
            .add(HtmlConfiguration.ConditionalPage.SERIALIZED_FORM);
    }
    ...
    public Content getPackageHeader(PackageElement packageElement) {
        var heading
            = HtmlTree.HEADING_TITLE(Headings.SerializedForm.PACKAGE_HEADING,
                contents.packageLabel);
        heading.add(Entity.NO_BREAK_SPACE);
        heading.add(getPackageLink(packageElement,
    ...
    public boolean isVisibleClass(TypeElement typeElement) {
        return visibleClasses.contains(typeElement)
            && configuration.isGeneratedDoc(typeElement)
    ...
    public Content getClassHeader(TypeElement typeElement) {
        ...
        Content superClassLink = typeElement.getSuperclass() != null
            ...
            : null;
        Content interfaceLink = getLink(new HtmlLinkInfo(configuration,
            HtmlLinkInfo.Kind.LINK_TYPE_PARAMS_AND_BOUNDS,
        ...
        section.add(
            HtmlTree.HEADING(Headings.SerializedForm.CLASS_HEADING, className));
