    ...
    private Content toContent() {
        ...
        for (Content cellContent : cellContents) {
            ...
            if (sortable != null && sortable[i]) {
                cell.put(HtmlAttr.ONCLICK,
                    "sortTable(this, " + i + ", " + sortable.length + ")");
                // Current tables happen to be sorted by first column by
                // default, this may not hold true for future uses.
                if (i == 0) {
