...
public abstract class SubWriterHolderWriter extends HtmlDocletWriter {
    ...
    public SubWriterHolderWriter(HtmlConfiguration configuration,
            DocPath filename) {
     ...
     */
    protected void addIndexComment(Element member,
        ...
        if (utils.isDeprecated(member)) {
            ...
            if (te != null && utils.isTypeElement(te)
                && utils.isDeprecated(te)) {
                var deprLabel = HtmlTree.SPAN(HtmlStyle.deprecatedLabel,
                    getDeprecatedPhrase(te));
                div = HtmlTree.DIV(HtmlStyle.block, deprLabel);
                tdSummaryContent.add(div);
            }
        }
     ...
     * @param tdSummaryContent the content to which the comment will be added
     */
    public void addSummaryLinkComment(Element member,
            List<? extends DocTree> firstSentenceTags,
            Content tdSummaryContent) {
     ...
     */
    public void addSummary(HtmlStyle style, HtmlId htmlId, Content target,
            Content source) {
