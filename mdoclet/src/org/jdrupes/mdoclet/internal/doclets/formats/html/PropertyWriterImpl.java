...
import org.jdrupes.mdoclet.internal.doclets.toolkit.PropertyWriter;
...
public class PropertyWriterImpl extends AbstractMemberWriter
    ...
    @Override
    public void addDeprecated(ExecutableElement property,
    ...
    @Override
    public void addComments(ExecutableElement property,
            Content propertyContent) {
        ...
        if (!utils.getFullBody(property).isEmpty()) {
            if (holder.equals(typeElement) ||
                ...
                if (!utils.hasHiddenTag(holder)
                    ...
                    propertyContent.add(
                        HtmlTree.DIV(HtmlStyle.block, descriptionFromLabel));
                }
                writer.addInlineComment(property, propertyContent);
            }
        }
    ...
    @Override
    public Content getPropertyDetails(Content memberDetailsHeader,
    ...
    public void addInheritedSummaryLabel(TypeElement typeElement,
        ...
        var labelHeading = HtmlTree
            .HEADING(Headings.TypeDeclaration.INHERITED_SUMMARY_HEADING, label)
    ...
    protected void addInheritedSummaryLink(TypeElement typeElement,
        ...
        Content content
            = writer.getDocLink(HtmlLinkInfo.Kind.PLAIN, typeElement, member,
