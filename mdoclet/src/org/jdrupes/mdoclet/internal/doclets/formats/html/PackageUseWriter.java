...
public class PackageUseWriter extends SubWriterHolderWriter {
    ...
    public static void generate(HtmlConfiguration configuration,
        ...
        PackageUseWriter pkgusegen
            = new PackageUseWriter(configuration, mapper, filename, pkgElement);
    ...
    protected void addClassList(Content content) {
        ...
        for (String packageName : usingPackageToUsedClasses.keySet()) {
            PackageElement usingPackage
                = utils.elementUtils.getPackageElement(packageName);
            ...
            Content caption = contents.getContent(
                ...
                getPackageLink(usingPackage,
                    getLocalizedPackageName(usingPackage)));
            var table = new Table<Void>(HtmlStyle.summaryTable)
                .setCaption(caption)
            ...
            for (TypeElement te : usingPackageToUsedClasses.get(packageName)) {
                ...
                Content typeContent = links.createLink(
                    dp.fragment(htmlIds.forPackage(usingPackage).name()),
                    stringContent);
                Content summary = new ContentBuilder();
    ...
    private HtmlTree getBody() {
        ...
        String name = packageElement.isUnnamed() ? ""
        ...
        headingContent
            .add(contents.getContent("doclet.ClassUse_Title", packageText));
