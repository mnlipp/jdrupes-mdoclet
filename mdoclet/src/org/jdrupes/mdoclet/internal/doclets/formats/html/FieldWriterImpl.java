...
import org.jdrupes.mdoclet.internal.doclets.toolkit.FieldWriter;
...
public class FieldWriterImpl extends AbstractMemberWriter
    ...
    @Override
    public Content getFieldDetails(Content memberDetailsHeaderContent,
    ...
    protected void addSummaryType(Element member, Content content) {
        addModifiersAndType(member, utils.asInstantiatedFieldType(typeElement,
            (VariableElement) member), content);
    }
