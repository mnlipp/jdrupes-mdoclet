...
public class HtmlLinkInfo {
    ...
    // The executable element we want to link to. Null if we are not linking to
     ...
     */
    public HtmlLinkInfo(HtmlConfiguration configuration, Kind context,
     ...
     * @return this object
     */
    public HtmlLinkInfo addLineBreaksInTypeParameters(
     ...
     * @return this object
     */
    public HtmlLinkInfo addLineBreakOpportunitiesInTypeParameters(
            boolean addLineBreakOpportunities) {
        this.addLineBreakOpportunitiesInTypeParameters
     ...
     */
    public HtmlLinkInfo
            showTypeParameterAnnotations(boolean showTypeParameterAnnotations) {
    ...
    private void setContext(Kind c) {
        linkTypeParameters = c == Kind.LINK_TYPE_PARAMS
            || c == Kind.LINK_TYPE_PARAMS_AND_BOUNDS;
        showTypeBounds = c == Kind.SHOW_TYPE_PARAMS_AND_BOUNDS
            || c == Kind.LINK_TYPE_PARAMS_AND_BOUNDS;
        context = c;
    }
    ...
    public Content getClassLinkLabel(BaseConfiguration configuration) {
        if (label != null && !label.isEmpty()) {
            ...
            tlabel.add(type instanceof DeclaredType dt
                && utils.isGenericType(dt.getEnclosingType())
                    // If enclosing type is rendered as separate links only use
                    // own class name
