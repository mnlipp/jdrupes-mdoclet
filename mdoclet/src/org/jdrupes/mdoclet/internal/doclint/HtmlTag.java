...
import static org.jdrupes.mdoclet.internal.doclint.HtmlTag.Attr.*;
 ...
 *
 * This class is derivative of {@link org.jdrupes.mdoclet.internal.doclets.formats.html.markup.TagName}.
...
public enum HtmlTag {
    ...
    FONT(ElemKind.HTML4, BlockType.INLINE, EndKind.REQUIRED, // tag itself is
                                                             // deprecated
            EnumSet.of(Flag.EXPECT_CONTENT),
    ...
    TD(BlockType.TABLE_ITEM, EndKind.OPTIONAL,
            ...
            attrs(AttrKind.HTML4, AXIS, Attr.ABBR, SCOPE, ALIGN, VALIGN, CHAR,
                CHAROFF,
    ...
    TH(BlockType.TABLE_ITEM, EndKind.OPTIONAL,
            ...
            attrs(AttrKind.HTML4, WIDTH, BGCOLOR, HEIGHT, NOWRAP, AXIS, ALIGN,
                CHAR, CHAROFF, VALIGN)),
    ...
    HtmlTag(ElemKind elemKind, BlockType blockType, EndKind endKind,
            AttrMap... attrMaps) {
        this(elemKind, blockType, endKind, Set.of(), attrMaps);
    }

    HtmlTag(BlockType blockType, EndKind endKind, Set<Flag> flags,
            AttrMap... attrMaps) {
        this(ElemKind.OK, blockType, endKind, flags, attrMaps);
    }

    HtmlTag(ElemKind elemKind, BlockType blockType, EndKind endKind,
            Set<Flag> flags, AttrMap... attrMaps) {
    ...
    public boolean accepts(HtmlTag t) {
        if (flags.contains(Flag.ACCEPTS_BLOCK)
            && flags.contains(Flag.ACCEPTS_INLINE)) {
            return (t.blockType == BlockType.BLOCK)
                || (t.blockType == BlockType.INLINE);
