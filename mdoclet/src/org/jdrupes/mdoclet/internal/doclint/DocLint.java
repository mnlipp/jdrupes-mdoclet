...
public class DocLint extends com.sun.tools.doclint.DocLint {
    ...
    public static void main(String... args) {
        ...
        try {
            ...
            System.err.println(
                dl.localize("dc.main.ioerror", e.getLocalizedMessage()));
            System.exit(2);
        }
    }
    ...
    void processArgs(String... args) throws BadArgs {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            } else if ((arg.equals("-target") || arg.equals("-source"))
                && i + 1 < args.length) {
                javacOpts.add(arg);
                javacOpts.add(args[++i]);
     ...
     * @param args     arguments to configure DocLint
     */
    public void init(DocTrees trees, Elements elements, Types types,
            String... args) {
        env = new Env();
    ...
    public boolean isValidOption(String opt) {
        ...
        if (opt.startsWith(XMSGS_CUSTOM_PREFIX))
            return Messages.Options
                .isValidOptions(opt.substring(XMSGS_CUSTOM_PREFIX.length()));
    ...
    public boolean isGroupEnabled(Messages.Group group,
