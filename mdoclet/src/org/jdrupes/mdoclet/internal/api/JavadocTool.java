...
package org.jdrupes.mdoclet.internal.api;
...
import org.jdrupes.mdoclet.internal.api.JavadocTaskImpl;
...
public class JavadocTool implements DocumentationTool {
    ...
    public DocumentationTask getTask(
        ...
        try {
            ...
            if (compilationUnits != null) {
                compilationUnits = ccw.wrapJavaFileObjects(compilationUnits); // implicit
                                                                              // null
                                                                              // check
                for (JavaFileObject cu : compilationUnits) {
                    if (cu.getKind() != JavaFileObject.Kind.SOURCE) {
                        final String kindMsg
            ...
            if (diagnosticListener != null)
                context.put(DiagnosticListener.class,
                    ccw.wrap(diagnosticListener));
            ...
            return new JavadocTaskImpl(context, docletClass, options,
                compilationUnits);
    ...
    public StandardJavaFileManager getStandardFileManager(
        ...
        PrintWriter pw = (charset == null)
            ...
            : new PrintWriter(new OutputStreamWriter(System.err, charset),
                true);
